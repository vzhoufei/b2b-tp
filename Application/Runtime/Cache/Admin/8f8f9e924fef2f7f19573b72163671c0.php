						  ...
						  <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr role="row" align="center">
		                     ...
		                     <td>
		                      ...
		                      <a class="btn btn-primary" href="<?php echo U('Article/article',array('act'=>'edit','article_id'=>$vo['article_id']));?>"><i class="fa fa-pencil"></i></a>
								 <?php if(!in_array(($vo["article_id"]), is_array($article_able_id)?$article_able_id:explode(',',$article_able_id))): ?><a class="btn btn-danger" href="javascript:void(0)" data-url="<?php echo U('Article/aticleHandle');?>" data-id="<?php echo ($vo["article_id"]); ?>" onclick="delfun(this)"><i class="fa fa-trash-o"></i></a><?php endif; ?>
								 <?php if(in_array(($vo["article_id"]), is_array($article_able_id)?$article_able_id:explode(',',$article_able_id))): ?><a class="btn btn-default disabled" href="javascript:void(0)"><i class="fa fa-trash-o"></i></a><?php endif; ?>
							</td>
