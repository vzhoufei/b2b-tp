		              ...
		              <table id="list-table" class="table table-bordered table-striped dataTable">
						...
						<tbody>
                          <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr role="row">    
                             <td><?php echo ($vo["complain_id"]); ?></td>
                             <td><?php echo ($vo["accuser_name"]); ?></td>
		                     <td><?php echo ($vo["order_goods_id"]); ?></td>
		                     <td><?php echo ($vo["complain_subject_content"]); ?></td>	                    
		                     <td><?php echo (date('Y-m-d H:i:s',$vo["complain_datetime"])); ?></td>                                  
		                     <td><?php echo ($vo["complain_state"]); ?></td>
		                     <td class="text-center">
		                      	<a class="btn btn-info" href="<?php echo U('Comment/complain_info',array('complain_id'=>$vo['complain_id']));?>">查看</a>
				     		</td>
