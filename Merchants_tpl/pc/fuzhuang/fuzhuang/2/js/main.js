$(function(){
	$('.index_product .show').eq(0).css('display','block')
    $('.index_product ul li').eq(0).addClass('active');
	$('.index_product ul li').mouseover(function(){
		$(this).addClass('active').siblings().removeClass('active');
		$('.index_product .show').hide().eq($(this).index()).show();
	});
	
	//mybanner		
    $(".mymybanner .hd li").eq(0).addClass("on");
